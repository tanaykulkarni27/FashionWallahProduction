  ...
  return (
    <div className={`relative w-full h-screen ${Banner_Data[activeIndex].class}`}>
      {Banner_Data.map((item,index)=>{
        ...
        leaveTo="opacity-0"
      >
        <div className={'m-0 w-full h-full flex flex-row justify-center items-center md:pt-[2vh]  sm:pt-[2vh] ' + item.class}>
          <div className='relative w-[90vw] md:w-[70vw] h-[90vh] md:h-[70vh]'>
            <img
              src={item.image.url}
              className="rounded-2xl w-[90vw] md:w-[70vw] h-[90vh] md:h-[70vh]"
            />
